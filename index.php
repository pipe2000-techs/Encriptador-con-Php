...
<html lang="en">
  ...
  <header class="masthead mb-auto">
    <div class="inner">
      ...
      <nav class="nav nav-masthead justify-content-center">
        <a class="nav-link active" href="/encriptacion">Encriptar</a>
        <a class="nav-link" href="desencriptar.php">Desencriptar</a>
      </nav>
    </div>
  </header>
  ...
  <main role="main" class="inner cover">
      ...
      <h1 class="cover-heading">Datos Para Encriptar</h1><br><br>
        ...
        <form class="needs-validation" action="index.php" method="post">
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <textarea name="solucion" rows="4" class="form-control" placeholder="Se Mostrara El mensage Encriptado......"><?php $solucion -> solucion($_POST['encriptar'], $mensage, $clave);?></textarea>
          ...
          <hr class="mb-4">
          <button class="btn btn-primary btn-lg btn-block" type="submit" name="encriptar" value="encriptar">Encriptar</button>
        </form>
